...
<!-- Content Sections -->
	        <div class="row">
	        	...
	        	<div class="span8">
	        	<form method='post'>
				Select a Location:<select style="margin-left:20px" id='where'>
	        	...
	        	Select a User:<select style="margin-left:49px" id='user'>
	        		<?php
	        	...
	        	<br>
				Select a date: <input style="margin-left:50px" type='date' id='date'></input></tr>
	        	</table>
	        	</form>
